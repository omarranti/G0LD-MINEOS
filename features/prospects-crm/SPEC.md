...
- **Reuse confidence:** adapt-the-shape (the patterns are clean and portable, but everything is wired to Loft's hand-rolled types, sentinel-user scoping, and Tailwind design tokens, so nothing is literally drop-in)
...
## Adaptation notes
- **Types:** Loft hand-writes `Prospect`, `Contact`, the status/relationship/seniority enums,
