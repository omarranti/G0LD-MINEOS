...
**One-liner** (clones/updates the repo to `~/G0LD-MINEOS` and
...
```bash
git clone https://github.com/omarranti/G0LD-MINEOS ~/G0LD-MINEOS
mkdir -p ~/.claude/skills/g0ld-mineos
cp ~/G0LD-MINEOS/skills/g0ld-mineos/SKILL.md ~/.claude/skills/g0ld-mineos/SKILL.md
```
